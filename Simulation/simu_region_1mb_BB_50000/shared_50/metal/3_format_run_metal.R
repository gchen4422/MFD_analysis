...
for (num in num_causal){
  for (h2 in h2_num){
    ...
    wrk_dir    <- paste0("/scratch/negishi/chen4422/hapnest/Simulation_update/simu_region_1mb_BB_50000/shared_50/causal_num_", num, "/")
...
metal_scripts <- c(
  "/scratch/negishi/chen4422/hapnest/Simulation_update/simu_region_1mb_BB_50000/shared_50/causal_num_1/summary_data/combined_1_h2_1_metal.txt",
  "/scratch/negishi/chen4422/hapnest/Simulation_update/simu_region_1mb_BB_50000/shared_50/causal_num_1/summary_data/combined_1_h2_2_metal.txt",
  "/scratch/negishi/chen4422/hapnest/Simulation_update/simu_region_1mb_BB_50000/shared_50/causal_num_2/summary_data/combined_2_h2_1_metal.txt",
  "/scratch/negishi/chen4422/hapnest/Simulation_update/simu_region_1mb_BB_50000/shared_50/causal_num_2/summary_data/combined_2_h2_2_metal.txt",
  "/scratch/negishi/chen4422/hapnest/Simulation_update/simu_region_1mb_BB_50000/shared_50/causal_num_3/summary_data/combined_3_h2_1_metal.txt",
  "/scratch/negishi/chen4422/hapnest/Simulation_update/simu_region_1mb_BB_50000/shared_50/causal_num_3/summary_data/combined_3_h2_2_metal.txt"
)
