...
sst_file <- paste0("/scratch/negishi/chen4422/hapnest/Simulation_update/simu_region_1mb_BB_50000/shared_50/causal_num_", num_causal, 
                   "/summary_data/CAUSAL_", num_causal, "_LOCI_", LD_BLOCK, "_h2_", h2_num, "_eur,/scratch/negishi/chen4422/hapnest/Simulation_update/simu_region_1mb_BB_50000/shared_50/causal_num_", 
...
ld_file <- paste0("/scratch/negishi/chen4422/hapnest/Simulation_update/simu_region_1mb_BB_50000/shared_50/susiex_ld_eur/loci_", LD_BLOCK, 
                  ".ld,/scratch/negishi/chen4422/hapnest/Simulation_update/simu_region_1mb_BB_50000/shared_50/susiex_ld_afr/loci_", LD_BLOCK, ".ld")
...
command <- paste(
  ...
  "--n_gwas=300000,50000",
  "--out_dir=/scratch/negishi/chen4422/hapnest/Simulation_update/simu_region_1mb_BB_50000/shared_50/susiex_result",
...
susie_BB<-susie_rss(zfile$zscore_2,BB_cov,check_prior=F, n = 50000)
