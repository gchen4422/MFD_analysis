...
res_out_name<-c("shared_50_BB_50000_updated_xmap_meta.RData")
library(ggplot2)
library(ggrepel)
library(grid)
library(egg)
...
###Time Plot
load(paste0(res_dir,"shared_50_BB_50000.RData"))
...
ggsave(paste0("/scratch/negishi/chen4422/hapnest/Simulation_update/simu_region_1mb_BB_50000/res_summary/Figure/shared_50_baseline/Time.pdf"),p_time,height = 120, width = 121,units = "mm",dpi=500)
...
# Call the function
Compare_Plot(paste0("/scratch/negishi/chen4422/hapnest/Simulation_update/simu_region_1mb_BB_50000/res_summary/"), "shared_50_BB_50000_updated_xmap.RData", "Black British = 50000", "Black British = 300000")
