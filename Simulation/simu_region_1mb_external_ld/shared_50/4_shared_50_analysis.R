...
summary_stat_1_bim = read.table(paste0("/scratch/negishi/chen4422/hapnest/Simulation_update/simu_region_1mb_external_ld/risk_loci_ld_eur/loci_",LD_BLOCK,".bim"))
summary_stat_2_bim = read.table(paste0("/scratch/negishi/chen4422/hapnest/Simulation_update/simu_region_1mb_external_ld/risk_loci_ld_afr/loci_",LD_BLOCK,".bim"))
...
summary_stat_1_bim_1kg = read.table(paste0("/scratch/negishi/chen4422/hapnest/Simulation_update/simu_region_1mb_external_ld/risk_loci_ld_eur/loci_1kg_",LD_BLOCK,".bim"))
summary_stat_2_bim_1kg = read.table(paste0("/scratch/negishi/chen4422/hapnest/Simulation_update/simu_region_1mb_external_ld/risk_loci_ld_afr/loci_1kg_",LD_BLOCK,".bim"))
summary_stat_1_bim_1kg$V2 = summary_stat_1_bim$V2
summary_stat_2_bim_1kg$V2 = summary_stat_2_bim$V2





write.table(summary_stat_1_bim_1kg,file = paste0("/scratch/negishi/chen4422/hapnest/Simulation_update/simu_region_1mb_external_ld/risk_loci_ld_eur/loci_1kg_",LD_BLOCK,".bim"),col.names = F,row.names = F,quote=F, sep ="\t")
write.table(summary_stat_2_bim_1kg,file = paste0("/scratch/negishi/chen4422/hapnest/Simulation_update/simu_region_1mb_external_ld/risk_loci_ld_afr/loci_1kg_",LD_BLOCK,".bim"),col.names = F,row.names = F,quote=F, sep ="\t")
...
loci_info = fread("/scratch/negishi/chen4422/hapnest/Simulation_update/simu_region_1mb_external_ld/simulation_locus_info.txt")
...
sst_file <- paste0("/scratch/negishi/chen4422/hapnest/Simulation_update/simu_region_1mb_external_ld/shared_50/causal_num_", num_causal, 
                   "/summary_data/CAUSAL_", num_causal, "_LOCI_", LD_BLOCK, "_h2_", h2_num, "_eur,/scratch/negishi/chen4422/hapnest/Simulation_update/simu_region_1mb_external_ld/shared_50/causal_num_", 
...
time_vec<-c(MESuSiE.time,susie.time,Paintor.time, xmap.time, susiex.time)
