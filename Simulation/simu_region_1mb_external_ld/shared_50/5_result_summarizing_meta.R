...
res_out<-"shared_50_external_ld_updated_xmap_meta.RData"
library(ggplot2)
library(ggrepel)
library(grid)
library(egg)
...
combined_data <- bind_rows(
  ...
  # 2. Select specific columns and Reorder
  # Remove 'Cutoff' and set the reporting order
  select(Method, h2, causal_num, FDR, Power, Signal_Type)
