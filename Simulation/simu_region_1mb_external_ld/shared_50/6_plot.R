...
res_out_name<-c("shared_50_external_ld_updated_xmap_meta.RData")
library(ggplot2)
library(ggrepel)
library(grid)
library(egg)
...
###Time Plot
load(paste0(res_dir,"shared_50_external_ld.RData"))
...
ggsave(paste0("/scratch/negishi/chen4422/hapnest/Simulation_update/simu_region_1mb_external_ld/res_summary/Figure/shared_50_baseline/Time.pdf"),p_time,height = 120, width = 121,units = "mm",dpi=500)
