...
data_dir_flipped = paste0(data_dir,"susie_rss/")
system(paste0("mkdir -p ",data_dir_flipped))
result_dir<-paste0(wrk_dir,"result/susie_rss/")
...
z_file_out <- paste0(data_dir_flipped, "CAUSAL_", num_causal, "_LOCI_", LD_BLOCK, "_h2_", h2_num, "_susie_rss")
write.table(zfile_sub,z_file_out,col.names = T,row.names = F,quote=F,sep=" ")  
ld_EU_paintor_name<-paste0(data_dir_flipped,"CAUSAL_", num_causal, "_LOCI_", LD_BLOCK, "_h2_", h2_num,"_susie_rss.LD1")
ld_BB_paintor_name<-paste0(data_dir_flipped,"CAUSAL_", num_causal, "_LOCI_", LD_BLOCK, "_h2_", h2_num,"_susie_rss.LD2")
...
annotation_paintor_name<-paste0(data_dir_flipped, "CAUSAL_", num_causal,
                                "_LOCI_",  LD_BLOCK,
                                "_h2_",    h2_num,"_susie_rss.annotations")
...
write.table(paste0("CAUSAL_", num_causal,
                   "_LOCI_",  LD_BLOCK,
                   "_h2_",    h2_num,"_susie_rss"),input_file_name,col.names = F,row.names = F,quote=F)
