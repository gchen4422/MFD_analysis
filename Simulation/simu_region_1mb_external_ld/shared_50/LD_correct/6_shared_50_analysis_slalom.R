...
#library(susieR)
library(data.table)
#source("/scratch/negishi/chen4422/hapnest/Simulation_update/simu_region_1mb_external_ld/shared_50_mesusie_inf/MESuSiE_original/modified_kriging_rss.R")
...
data_dir_flipped_slalom = paste0(data_dir,"slalom/")
...
LD_dir_eur <- paste0("/scratch/negishi/chen4422/hapnest/Simulation_update/simu_region_1mb_external_ld/shared_50/causal_num_",num_causal,"/summary_data/")

geno_dir_afr <- paste0("/scratch/negishi/chen4422/hapnest/Simulation_update/simu_region_1mb_external_ld/risk_loci_ld_afr")
LD_dir_afr <- paste0("/scratch/negishi/chen4422/hapnest/Simulation_update/simu_region_1mb_external_ld/shared_50/causal_num_",num_causal,"/summary_data/")
...
bim_eur <- fread(
  paste0("/scratch/negishi/chen4422/hapnest/Simulation_update/simu_region_1mb_external_ld/risk_loci_ld_eur/loci_", LD_BLOCK, ".bim"),
  header = FALSE
) %>%
  transmute(SNP = V2, A1 = V5, A2 = V6)

bim_afr <- fread(
  paste0("/scratch/negishi/chen4422/hapnest/Simulation_update/simu_region_1mb_external_ld/risk_loci_ld_afr/loci_", LD_BLOCK, ".bim"),
  header = FALSE
) %>%
  transmute(SNP = V2, A1 = V5, A2 = V6)
...
write.table(summary_stat_1_susiex,file = paste0(data_dir_flipped_slalom,"CAUSAL_",num_causal,"_LOCI_",LD_BLOCK,"_h2_",h2_num,"_slalom_eur"),col.names = T,row.names = F,quote=F, sep ="\t")
write.table(summary_stat_2_susiex,file = paste0(data_dir_flipped_slalom,"CAUSAL_",num_causal,"_LOCI_",LD_BLOCK,"_h2_",h2_num,"_slalom_afr"),col.names = T,row.names = F,quote=F, sep ="\t")
#write.table(summary_stat_2_bim,file = paste0("/scratch/negishi/chen4422/hapnest/Simulation_update/simu_region_1mb_external_ld/risk_loci_ld_afr/loci_",LD_BLOCK,".bim"),col.names = F,row.names = F,quote=F, sep ="\t")
z_file_out <- paste0(data_dir_flipped_slalom, "CAUSAL_", num_causal, "_LOCI_", LD_BLOCK, "_h2_", h2_num, "_slalom")
write.table(zfile_sub,z_file_out,col.names = T,row.names = F,quote=F,sep=" ")  
ld_EU_paintor_name<-paste0(data_dir_flipped_slalom,"CAUSAL_", num_causal, "_LOCI_", LD_BLOCK, "_h2_", h2_num, "_slalom.LD1")
ld_BB_paintor_name<-paste0(data_dir_flipped_slalom,"CAUSAL_", num_causal, "_LOCI_", LD_BLOCK, "_h2_", h2_num,"_slalom.LD2")
...
sst_file <- paste0(data_dir_flipped_slalom,
                   "CAUSAL_", num_causal, "_LOCI_", LD_BLOCK, "_h2_", h2_num, "_slalom_eur,",data_dir_flipped_slalom, 
                   "CAUSAL_", num_causal, "_LOCI_", LD_BLOCK, "_h2_", h2_num, "_slalom_afr")

# Construct the ref_file argument
ref_file <- paste0("/scratch/negishi/chen4422/hapnest/Simulation_update/simu_region_1mb_external_ld/risk_loci_ld_eur/loci_1kg_", LD_BLOCK, 
                   ",/scratch/negishi/chen4422/hapnest/Simulation_update/simu_region_1mb_external_ld/risk_loci_ld_afr/loci_1kg_", LD_BLOCK)

# Construct the ld_file argument
ld_file <- paste0("/scratch/negishi/chen4422/hapnest/Simulation_update/simu_region_1mb_external_ld/shared_50/susiex_ld_eur/loci_1kg_", LD_BLOCK, 
                  ".ld,/scratch/negishi/chen4422/hapnest/Simulation_update/simu_region_1mb_external_ld/shared_50/susiex_ld_afr/loci_1kg_", LD_BLOCK, ".ld")



# Define the out_name variable
out_name <- paste0("SuSiEx_CAUSAL_", num_causal, "_LOCI_", LD_BLOCK, "_h2_", h2_num, "_output_cs95_slalom")
...
annotation_paintor_name<-paste0(data_dir_flipped_slalom, "CAUSAL_", num_causal,
                                "_LOCI_",  LD_BLOCK,
                                "_h2_",    h2_num,"_slalom.annotations")


write.table(annotation_file,annotation_paintor_name,col.names = T,row.names = F,quote=F)

input_file_name<-paste0(data_dir_flipped_slalom,"CAUSAL_",num_causal,"_LOCI_",LD_BLOCK,"_h2_",h2_num,"_slalom.input")
write.table(paste0("CAUSAL_", num_causal,
                   "_LOCI_",  LD_BLOCK,
                   "_h2_",    h2_num,"_slalom"),input_file_name,col.names = F,row.names = F,quote=F)




paintor_dir = data_dir_flipped_slalom
paintor_out_name<-paste0(paintor_dir,"CAUSAL_",num_causal,"_LOCI_",LD_BLOCK,"_h2_",h2_num,"_slalom")
input_file_name<-paste0(paintor_dir,"CAUSAL_",num_causal,"_LOCI_",LD_BLOCK,"_h2_",h2_num,"_slalom.input")
ld_EU_paintor_name<-paste0(data_dir_flipped_slalom,"CAUSAL_", num_causal, "_LOCI_", LD_BLOCK, "_h2_", h2_num, "_slalom.LD1")
ld_BB_paintor_name<-paste0(data_dir_flipped_slalom,"CAUSAL_", num_causal, "_LOCI_", LD_BLOCK, "_h2_", h2_num, "_slalom.LD2")
paintor_suffix<-paste0("CAUSAL_",num_causal,"_LOCI_",LD_BLOCK,"_h2_",h2_num)
input_dir<-data_dir_flipped_slalom
start.time<-Sys.time()
