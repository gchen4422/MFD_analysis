...
for (num in num_causal){
  for (h2 in h2_num){
    ...
    wrk_dir    <- paste0("/scratch/negishi/chen4422/hapnest/Simulation_update/simu_region_admix/causal_num_", num, "/")
...
write_metal_per_combo(num_causal = c(1,2,3), h2_num = c(1), file_ext = ".tsv")
...
metal_scripts <- c(
  "/scratch/negishi/chen4422/hapnest/Simulation_update/simu_region_admix/causal_num_1/summary_data/combined_1_h2_1_metal.txt",
  "/scratch/negishi/chen4422/hapnest/Simulation_update/simu_region_admix/causal_num_1/summary_data/combined_1_h2_2_metal.txt",
  "/scratch/negishi/chen4422/hapnest/Simulation_update/simu_region_admix/causal_num_2/summary_data/combined_2_h2_1_metal.txt",
  "/scratch/negishi/chen4422/hapnest/Simulation_update/simu_region_admix/causal_num_2/summary_data/combined_2_h2_2_metal.txt",
  "/scratch/negishi/chen4422/hapnest/Simulation_update/simu_region_admix/causal_num_3/summary_data/combined_3_h2_1_metal.txt",
  "/scratch/negishi/chen4422/hapnest/Simulation_update/simu_region_admix/causal_num_3/summary_data/combined_3_h2_2_metal.txt"
)
