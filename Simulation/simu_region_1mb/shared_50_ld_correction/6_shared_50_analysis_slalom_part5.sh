...
SCRIPT=/scratch/negishi/chen4422/hapnest/Simulation_update/simu_region_1mb/shared_50_ld_correction/6_shared_50_analysis_slalom.R

# List of 5-arg parameter sets (space-separated), 14 total
PARAMS=(
  "68 2 2 1 4"
  "68 2 2 2 3"
