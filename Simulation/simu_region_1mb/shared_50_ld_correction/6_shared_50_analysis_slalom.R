...
write.table(summary_stat_1_susiex,file = paste0(data_dir_flipped,"CAUSAL_",num_causal,"_LOCI_",LD_BLOCK,"_h2_",h2_num,"_slalom_eur"),col.names = T,row.names = F,quote=F, sep ="\t")
write.table(summary_stat_2_susiex,file = paste0(data_dir_flipped,"CAUSAL_",num_causal,"_LOCI_",LD_BLOCK,"_h2_",h2_num,"_slalom_afr"),col.names = T,row.names = F,quote=F, sep ="\t")
...
z_file_out <- paste0(data_dir_flipped, "CAUSAL_", num_causal, "_LOCI_", LD_BLOCK, "_h2_", h2_num, "_flipped_", flip_prop, "_rho_", rho_num, "_slalom")
write.table(zfile_sub,z_file_out,col.names = T,row.names = F,quote=F,sep=" ")  
ld_EU_paintor_name<-paste0(data_dir_flipped,"CAUSAL_", num_causal, "_LOCI_", LD_BLOCK, "_h2_", h2_num, "_flipped_", flip_prop, "_rho_", rho_num,"_slalom.LD1")
ld_BB_paintor_name<-paste0(data_dir_flipped,"CAUSAL_", num_causal, "_LOCI_", LD_BLOCK, "_h2_", h2_num, "_flipped_", flip_prop, "_rho_", rho_num,"_slalom.LD2")
...
sst_file <- paste0(data_dir_flipped,
                   "CAUSAL_", num_causal, "_LOCI_", LD_BLOCK, "_h2_", h2_num, "_slalom_eur,",data_dir_flipped, 
...
annotation_paintor_name<-paste0(data_dir_flipped, "CAUSAL_", num_causal,
                                ...
                                "_h2_",    h2_num,
                                "_flipped_",flip_prop,
                                "_rho_",   rho_num,"_slalom.annotations")


write.table(annotation_file,annotation_paintor_name,col.names = T,row.names = F,quote=F)

input_file_name<-paste0(data_dir_flipped,"CAUSAL_",num_causal,"_LOCI_",LD_BLOCK,"_h2_",h2_num,"_slalom.input")
write.table(paste0("CAUSAL_", num_causal,
                   "_LOCI_",  LD_BLOCK,
                   "_h2_",    h2_num,
                   "_flipped_",flip_prop,
                   "_rho_",   rho_num,"_slalom"),input_file_name,col.names = F,row.names = F,quote=F)
