...
res_out_name <- c("flipped_1_rho_1_updated.RData","flipped_1_rho_2_updated.RData","flipped_1_rho_3_updated.RData","flipped_1_rho_4_updated.RData","flipped_2_rho_1_updated.RData","flipped_2_rho_2_updated.RData","flipped_2_rho_3_updated.RData","flipped_2_rho_4_updated.RData","flipped_3_rho_1_updated.RData","flipped_3_rho_2_updated.RData","flipped_3_rho_3_updated.RData","flipped_3_rho_4_updated.RData")
#res_out_name_slalom <- c("flipped_1_rho_1_slalom.RData","flipped_1_rho_2_slalom.RData","flipped_1_rho_3_slalom.RData","flipped_1_rho_4_slalom.RData","flipped_2_rho_1_slalom.RData","flipped_2_rho_2_slalom.RData","flipped_2_rho_3_slalom.RData","flipped_2_rho_4_slalom.RData","flipped_3_rho_1_slalom.RData","flipped_3_rho_2_slalom.RData","flipped_3_rho_3_slalom.RData","flipped_3_rho_4_slalom.RData")
#res_out_name_susie_rss <- c("flipped_1_rho_1_susie_rss.RData","flipped_1_rho_2_susie_rss.RData","flipped_1_rho_3_susie_rss.RData","flipped_1_rho_4_susie_rss.RData","flipped_2_rho_1_susie_rss.RData","flipped_2_rho_2_susie_rss.RData","flipped_2_rho_3_susie_rss.RData","flipped_2_rho_4_susie_rss.RData","flipped_3_rho_1_susie_rss.RData","flipped_3_rho_2_susie_rss.RData","flipped_3_rho_3_susie_rss.RData","flipped_3_rho_4_susie_rss.RData")
...
ggsave(
  file.path(res_dir, "Figure", "LD_no_correct_Set_size_all_flips_rhos_combined.pdf"),
  p_size_box_all,
  height = 210, width = 300, units = "mm", dpi = 500
)
...
ggsave(
  file.path(res_dir, "Figure", "LD_no_correct_power_all_flips_rhos_combined.pdf"),
  p_power_bar_all,
  height = 210, width = 300, units = "mm", dpi = 500
)
...
ggsave(
  file.path(res_dir, "Figure", "LD_no_correct_roc_either_all_flips_rhos_combined.pdf"),
  p_ROC_Either_all,
  height = 210, width = 300, units = "mm", dpi = 500
)
...
ggsave(
  file.path(res_dir, "Figure", "LD_no_correct_fdr_power_either_all_flips_rhos_combined.pdf"),
...
ggsave(
  file.path(res_dir, "Figure", "LD_no_correct_roc_shared_all_flips_rhos_combined.pdf"),
  p_ROC_shared_all,
  height = 210, width = 300, units = "mm", dpi = 500
)
...
ggsave(
  file.path(res_dir, "Figure", "LD_no_correct_fdr_power_shared_all_flips_rhos_combined.pdf"),
...
ggsave(
  file.path(res_dir, "Figure", "LD_no_correct_roc_ancestry_all_flips_rhos_combined.pdf"),
  p_ROC_ancestry_all,
  height = 210, width = 300, units = "mm", dpi = 500
)
...
ggsave(
  file.path(res_dir, "Figure", "LD_no_correct_fdr_power_ancestry_all_flips_rhos_combined.pdf"),
