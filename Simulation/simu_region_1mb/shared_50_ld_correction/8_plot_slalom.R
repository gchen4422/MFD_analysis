...
#res_out_name <- c("flipped_1_rho_1.RData","flipped_1_rho_2.RData","flipped_1_rho_3.RData","flipped_1_rho_4.RData","flipped_2_rho_1.RData","flipped_2_rho_2.RData","flipped_2_rho_3.RData","flipped_2_rho_4.RData","flipped_3_rho_1.RData","flipped_3_rho_2.RData","flipped_3_rho_3.RData","flipped_3_rho_4.RData")
res_out_name_slalom <- c("flipped_1_rho_1_slalom_updated.RData","flipped_1_rho_2_slalom_updated.RData","flipped_1_rho_3_slalom_updated.RData","flipped_1_rho_4_slalom_updated.RData","flipped_2_rho_1_slalom_updated.RData","flipped_2_rho_2_slalom_updated.RData","flipped_2_rho_3_slalom_updated.RData","flipped_2_rho_4_slalom_updated.RData","flipped_3_rho_1_slalom_updated.RData","flipped_3_rho_2_slalom_updated.RData","flipped_3_rho_3_slalom_updated.RData","flipped_3_rho_4_slalom_updated.RData")
...
for(res_out in res_out_name_slalom){
...
ggsave(
  file.path(res_dir, "Figure", "LD_slalom_Set_size_all_flips_rhos_combined.pdf"),
  p_size_box_all,
  height = 210, width = 300, units = "mm", dpi = 500
)
...
ggsave(
  file.path(res_dir, "Figure", "LD_slalom_power_all_flips_rhos_combined.pdf"),
  p_power_bar_all,
  height = 210, width = 300, units = "mm", dpi = 500
)
...
ggsave(
  file.path(res_dir, "Figure", "LD_slalom_roc_either_all_flips_rhos_combined.pdf"),
  p_ROC_Either_all,
  height = 210, width = 300, units = "mm", dpi = 500
)
...
ggsave(
  file.path(res_dir, "Figure", "LD_slalom_fdr_power_either_all_flips_rhos_combined.pdf"),
...
ggsave(
  file.path(res_dir, "Figure", "LD_slalom_roc_shared_all_flips_rhos_combined.pdf"),
  p_ROC_shared_all,
  height = 210, width = 300, units = "mm", dpi = 500
)
...
ggsave(
  file.path(res_dir, "Figure", "LD_slalom_fdr_power_shared_all_flips_rhos_combined.pdf"),
...
ggsave(
  file.path(res_dir, "Figure", "LD_slalom_roc_ancestry_all_flips_rhos_combined.pdf"),
  p_ROC_ancestry_all,
  height = 210, width = 300, units = "mm", dpi = 500
)
...
ggsave(
  file.path(res_dir, "Figure", "LD_slalom_fdr_power_ancestry_all_flips_rhos_combined.pdf"),
