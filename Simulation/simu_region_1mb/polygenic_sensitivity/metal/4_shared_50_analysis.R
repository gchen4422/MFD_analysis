...
library(susieR)
start.time<-Sys.time()
susie_weighted<-susie_rss(metal_results_loci$Z,weighted_cov,check_prior=F, n = 600000,L= 20)
susie_weighted.time<-Sys.time()-start.time
susie_weighted.time<-as.numeric(susie_weighted.time,units = "mins")
start.time<-Sys.time()
susie_merged<-susie_rss(metal_results_loci$Z,merged_cov,check_prior=F, n = 600000,L= 20)
