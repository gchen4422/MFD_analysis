...
res_out_name<-c("polygenic_sensitivity.RData")
library(ggplot2)
library(ggrepel)
library(grid)
library(egg)
...
#for(res_out in res_out_name){
  ...
  #
  ###################
  either_all_ROC_data_dataframe<-either_all_ROC_data_dataframe%>%mutate(Method = recode(Method, "CARMAX" = "CARMA-X"))%>%mutate(Method = fct_relevel(Method,"MESuSiE","SuSiE","SuSiE_weighted","SuSiE_merged","Paintor","MultiSuSiE","SuSiEx","XMAP","CARMA-X"))
  ...
  #
  ###################
  shared_all_ROC_data_dataframe<-shared_all_ROC_data_dataframe%>%mutate(Method = recode(Method, "CARMAX" = "CARMA-X"))%>%mutate(Method = fct_relevel(Method,"MESuSiE","SuSiE","SuSiE_weighted","SuSiE_merged","Paintor","MultiSuSiE","SuSiEx","XMAP","CARMA-X"))
  ...
  )%>%mutate(Method = recode(Method, "CARMAX" = "CARMA-X"))%>%mutate(Method = fct_relevel(Method,c(
  ...
  FDR_Power_ancestry <- FDR_Power_ancestry%>%ungroup(h2,causal_num,Method) %>%mutate(
    Method = sapply(split_list, `[`, 1),
    Ancestry = sapply(split_list, `[`, 2)
  )%>%mutate(Method = recode(Method, "CARMAX" = "CARMA-X"))%>%mutate(Method = fct_relevel(Method, "MESuSiE","SuSiE","SuSiE_weighted","SuSiE_merged","Paintor","MultiSuSiE","SuSiEx","XMAP","CARMA-X"),Ancestry = fct_relevel(Ancestry, "WB","BB"))%>%mutate(Ancestry = fct_recode(Ancestry, "White British" = "WB"   , "Black British" = "BB" ))
  ...
  PIP_calibration_ancestry<- PIP_calibration_ancestry%>%group_by(causal_num)%>%mutate(Method = fct_recode(Method, "MESuSiE White British" = "MESuSiE~WB", "MESuSiE Black British" = "MESuSiE~BB","SuSiE White British" = "SuSiE~WB","SuSiE Black British" = "SuSiE~BB","SuSiE_weighted White British" = "SuSiE_weighted~WB","SuSiE_weighted Black British" = "SuSiE_weighted~BB","SuSiE_merged White British" = "SuSiE_merged~WB","SuSiE_merged Black British" = "SuSiE_merged~BB","Paintor White British" = "Paintor~WB","Paintor Black British" = "Paintor~BB","SuSiEx White British" = "SuSiEx~WB","SuSiEx Black British" = "SuSiEx~BB","XMAP White British" = "XMAP~WB","XMAP Black British" = "XMAP~BB","MultiSuSiE White British" = "MultiSuSiE~WB","MultiSuSiE Black British" = "MultiSuSiE~BB","CARMA-X White British" = "CARMAX~WB","CARMA-X Black British" = "CARMAX~BB"))
