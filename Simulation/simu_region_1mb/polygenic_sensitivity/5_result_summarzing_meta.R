simulation_dir<-"/scratch/negishi/chen4422/hapnest/Simulation_update/simu_region_1mb/polygenic_sensitivity/"
...
res_out<-"polygenic_sensitivity.RData"
library(ggplot2)
library(ggrepel)
library(grid)
library(egg)
...
for(causal_num in 1:2){
  for(h2 in 1:2){
    ...
    set3 = which(paste0("SuSiEx_CAUSAL_",causal_num,"_LOCI_",1:100,"_h2_",h2,"_output_cs95.snp")%in%list.files(paste0(simulation_dir,"susiex_result/")))
    set4 = which(paste0("MultiSuSiE_CAUSAL_",causal_num,"_LOCI_",1:100,"_h2_",h2,"_output_snp.txt")%in%list.files(paste0(simulation_dir,"multi_susie_result/")))
    set5 = which(paste0("Metal_SuSiE_CAUSAL_",causal_num,"_LOCI_",1:100,"_h2_",h2,"_updated.RData")%in%list.files())
    replicate_set = Reduce(intersect, list(set1,set2,set3,set4,set5))
    ...
    for(LOCI_num in replicate_set){
      ...
      ## xmap is already loaded from MESuSiE_*.RData above



      #format susiex results
      susiex_res_name<-paste0(simulation_dir,"susiex_result/","SuSiEx_CAUSAL_",causal_num,"_LOCI_",LOCI_num,"_h2_",h2,"_output_cs95.snp")
      susiex_cred_name<-paste0(simulation_dir,"susiex_result/","SuSiEx_CAUSAL_",causal_num,"_LOCI_",LOCI_num,"_h2_",h2,"_output_cs95.cs")
      ...
      ld_dir = paste0(simulation_dir,"causal_num_",causal_num,"/")
      ...
      multisusie_dir = paste0(simulation_dir,"multi_susie_result/")
