...
res_out<-"functional_annotation_sensitivity_w2.RData"
library(ggplot2)
library(ggrepel)
library(grid)
library(egg)
...
for(causal_num in 1:3){
  for(h2 in 1:2){
    ...
    for(LOCI_num in replicate_set){
      ...
      paintor_dir<-paste0(wrk_dir,"summary_data/w2_startover/")
      ...
      multisusie_dir = "/scratch/negishi/chen4422/hapnest/Simulation_update/simu_region_1mb/functional_annotation_sensitivity/multi_susie_result/"
