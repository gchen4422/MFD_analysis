...
for (num in num_causal){
  for (h2 in h2_num){
    ...
    wrk_dir    <- paste0("/scratch/negishi/chen4422/hapnest/Simulation_update/simu_region_1mb/functional_annotation_sensitivity/causal_num_", num, "/")
    data_dir   <- paste0(wrk_dir, "summary_data/w0_startover/")
    result_dir <- paste0(wrk_dir, "result/w0_startover/")
...
write_metal_per_combo <- function(num_causal, h2_num, file_ext = ".tsv") {
  for (num in num_causal) {
    for (h2 in h2_num) {
      # input and output paths
      wrk_dir    <- paste0("/scratch/negishi/chen4422/hapnest/Simulation_update/simu_region_1mb/functional_annotation_sensitivity/causal_num_", num, "/")
      data_dir   <- paste0(wrk_dir, "summary_data/w0_startover/")  # retained for directory consistency
      result_dir <- paste0(wrk_dir, "result/w0_startover/")
...
metal_scripts <- c(
  "/scratch/negishi/chen4422/hapnest/Simulation_update/simu_region_1mb/functional_annotation_sensitivity/causal_num_1/summary_data/w0_startover/combined_1_h2_1_metal.txt",
  "/scratch/negishi/chen4422/hapnest/Simulation_update/simu_region_1mb/functional_annotation_sensitivity/causal_num_1/summary_data/w0_startover/combined_1_h2_2_metal.txt",
  "/scratch/negishi/chen4422/hapnest/Simulation_update/simu_region_1mb/functional_annotation_sensitivity/causal_num_2/summary_data/w0_startover/combined_2_h2_1_metal.txt",
  "/scratch/negishi/chen4422/hapnest/Simulation_update/simu_region_1mb/functional_annotation_sensitivity/causal_num_2/summary_data/w0_startover/combined_2_h2_2_metal.txt",
  "/scratch/negishi/chen4422/hapnest/Simulation_update/simu_region_1mb/functional_annotation_sensitivity/causal_num_3/summary_data/w0_startover/combined_3_h2_1_metal.txt",
  "/scratch/negishi/chen4422/hapnest/Simulation_update/simu_region_1mb/functional_annotation_sensitivity/causal_num_3/summary_data/w0_startover/combined_3_h2_2_metal.txt"
)
